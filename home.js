...
const cardData = [
  {
    imageSrc: "images/women-fashion-img.jpg",
  ...
  {
    imageSrc: "images/men-fashion-img.jpg",
  ...
  {
    imageSrc: "images/footwear-img.jpg",
    title: "Latest Lorem Suit Up!",
    description:
      "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur!",
...
document.addEventListener("DOMContentLoaded", function () {
  const shopCardContainer = document.getElementById("shopCardContainer");

  // Loop through the card data and generate HTML for each card
  cardData.forEach(function (card) {
    const cardElement = document.createElement("div");
    cardElement.classList.add("shop-card");
    ...
    const cardHTML = `
          ...
          <div class="shop-card-overlay">
              <div class="shop-card-content">
                  ...
                  <a href="#" class="shop-card-button">${card.buttonText}</a>
              </div>
          </div>
      `;

    cardElement.innerHTML = cardHTML;
    shopCardContainer.appendChild(cardElement);
  });
});
// <----------------------------------------------------------------------------------------->
// section-4
